...
ERASE = [
    ...
    # На кнопке «ПРАВИЛА» стираем только надпись, а рамку оставляем: кнопка
    # сама по себе нужна, иначе в ряду зияет дыра. Поверх пишется «МЕНЮ»,
    # и ведёт она в настройки, а не в правила — те открываются из «?».
    (1192, 724, 1288, 756, 0),
]
